...
#define APPLICATION_NAME            "Rufus 7"
#if defined(_M_AMD64)
...
// Where Rufus should download Whitebar (Fido replacement)
#define WHITEBAR_URL                "https://github.com/Smu1zel/Whitebar/releases/download/v1.1/Whitebar.ps1.lzma"
